...
- **enable_repeat_pattern_filter**, **max_disparity_shift**, **peak_concavity_thresh**: *enable_repeat_pattern_filter* choose to detect regions of repeated pattern along sisparity search lines and mask out regions with strong repeated patterns.
